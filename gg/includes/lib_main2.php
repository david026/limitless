 ...
 * @return  array
 */
function assign_ur_here($cat = 18, $str = '')
{
    /* 判断是否重写，取得文件名 */
    ...
    /* 初始化“页面标题”和“当前位置” */
   // $page_title = $GLOBALS['_CFG']['shop_title'] . ' - ' . '汇横珍珠';
   $page_title = $GLOBALS['_CFG']['shop_title']; //分类页的标题 去掉上级分类名称
...
/**
 * 分配帮助信息
 *  我二次开发    帮助信息 把原先的    c.cat_type = 5  改成了  c.cat_type = 1
 *
 * @access  public
 * @return  array
 */
