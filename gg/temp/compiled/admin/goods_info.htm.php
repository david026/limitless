...
?>
          ...
          <tr id="auto_thumb_1">
            ...
            <td id="auto_thumb_3">
              ...
              <br /><label for="auto_thumb"><input type="checkbox" id="auto_thumb" name="auto_thumb" value="1" onclick="handleAutoThumb(this.checked)" /><?php echo $this->_var['lang']['auto_thumb']; ?></label><?php endif; ?>
            </td>
          </tr>
		        <tr>
            <td class="label">是否只能订制</td>
            <td>
              <input type="checkbox" name="is_made" id="is_made" value="1" <?php if ($this->_var['goods']['is_made']): ?>checked="checked"<?php endif; ?>/>(如果打勾表示此款珍珠产品没有现货,不能直接购买,需要订制)
			  <br />
			  订做工期说明:<input type="text" name="made_remarks" id="made_remarks" value="<?php echo $this->_var['goods']['made_remarks']; ?>" size="50"/>
            </td>
          </tr>
        </table>
